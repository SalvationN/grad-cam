...
with tf.Session(graph=eval_graph) as sess:    
    ...
    for i in range(batch_size):
		...
		if i==0:
			scipy.misc.imsave('/output/img.png', batch_img[i])
			scipy.misc.imsave('/output/layer.png', target_conv_layer_value[i])
			scipy.misc.imsave('/output/grad.png', target_conv_layer_grad_value[i])
